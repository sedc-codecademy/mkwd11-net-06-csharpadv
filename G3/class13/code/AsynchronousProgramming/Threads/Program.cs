...
void SendMessagesWithThreads2()
{
    ...
    {
        Thread.Sleep(2000);
        Console.WriteLine("4 message arrived");
    });
    ...
    {
        Thread.Sleep(2000);
        Console.WriteLine("5 message arrived");
    }).Start();

    new Thread(() =>
    {
        Thread.Sleep(2000);
        Console.WriteLine("6 message arrived");
    }).Start();
