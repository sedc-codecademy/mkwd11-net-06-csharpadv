...
orderDb.Insert(new Order() { Id = 2, Address = "Bulevar Partizanski Odredi br.10", Receiver = "Dragisha" });
orderDb.Insert(new Order() { Id = 3, Address = "Rudnicka br.10", Receiver = "Mitko" });
